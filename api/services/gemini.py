...
A5. When a tool outputs a specific time (e.g. "Currently it is 8:48 PM.") or contact information verbatim, you MUST include it exactly as provided in your response. Do not strip or heavily paraphrase such explicit information.
