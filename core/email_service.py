        ...
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
          ...
          <div style="padding: 30px;">
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                <td style="padding: 12px 0; border-bottom: 1px solid #f0f0f0; width: 30%; color: #6b7280; font-weight: 600; font-size: 14px;">User</td>
              ...
              <tr>
                ...
                <td style="padding: 12px 0; border-bottom: 1px solid #f0f0f0; color: #111827; font-size: 14px;">
                    <span style="background-color: #f3f4f6; color: #4b5563; padding: 4px 10px; border-radius: 4px; font-size: 13px;">{safe_category}</span>
                </td>
              </tr>
              <tr>
                <td style="padding: 12px 0; border-bottom: 1px solid #f0f0f0; color: #6b7280; font-weight: 600; font-size: 14px;">Subject</td>
                <td style="padding: 12px 0; border-bottom: 1px solid #f0f0f0; color: #111827; font-size: 15px; font-weight: 500;">{safe_subject}</td>
              </tr>
            </table>
            
            <div style="margin-top: 25px;">
              <p style="color: #6b7280; font-weight: 600; font-size: 14px; margin-bottom: 8px;">Description:</p>
              <div style="background-color: #f9fafb; padding: 16px; border-radius: 6px; border: 1px solid #e5e7eb; color: #374151; font-size: 14px; line-height: 1.6; white-space: pre-wrap;">{safe_description}</div>
            </div>
          </div>
          
          <div style="background-color: #f8f9fa; padding: 15px 20px; text-align: center; border-top: 1px solid #e5e7eb; color: #9ca3af; font-size: 12px;">
            Submitted At: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}
          </div>
        </div>
      </body>
